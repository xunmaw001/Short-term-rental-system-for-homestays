<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的民宿短租系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="房主账号" class="input" v-if="tableName=='fangzhu'">
			  <el-input v-model="ruleForm.fangzhuzhanghao" autocomplete="off" placeholder="房主账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fangzhu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='fangzhu'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="房主姓名" class="input" v-if="tableName=='fangzhu'">
			  <el-input v-model="ruleForm.fangzhuxingming" autocomplete="off" placeholder="房主姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fangzhu'" class="input-group">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='fangzhu'">
			...
			<el-form-item label="身份证号" class="input" v-if="tableName=='fangzhu'">
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20210128/5aa2b5f3e1b842f1a639e734555f3a7c.jpg);
